...
@Autonomous
//@Disabled
public class AngleAutoBlue extends LinearOpMode {
    // Pre init
    ...
    AngleAutoConstantsBlue autoConstants;
    ...
    public void runOpMode(){
        ...
        autoConstants = new AngleAutoConstantsBlue(drive);
