...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(30, 0.5, 1.5);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(13, 0.1, 0.5);
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        /* commented out because we're using three wheel odo
    ...
    /* commented out for three wheel odo
    @Override
    ...
    public void displayDeug(Telemetry telemetry){
        telemetry.addLine("DRIVE");
        telemetry.addData("X", getPoseEstimate().getX());
        telemetry.addData("Y", getPoseEstimate().getY());
        telemetry.addData("Heading", getPoseEstimate().getHeading());
    }
}
